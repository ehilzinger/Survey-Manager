...
class Organization(models.Model):
    ...
    """
    org_name = models.CharField(max_length=255, blank=False, null=False, primary_key=True)
...
class Profile(models.Model):
    ...
    org = models.ForeignKey(to=Organization, on_delete=models.CASCADE, blank=True, null=True)
